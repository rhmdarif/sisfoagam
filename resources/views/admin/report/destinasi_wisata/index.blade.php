...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Report Destinasi Wisata</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Report Destinasi Wisata</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-lg-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <a href="{{ route('admin.report.destinasi_wisata.download') }}" class="btn btn-primary float-right">Download</a>
                        </div>
                        <div class="card-body">
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <h5>REKAP DATA PENGUNJUNG WISATA</h5>
