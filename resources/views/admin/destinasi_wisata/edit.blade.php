            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-outline card-primary">
                        <div class="card-body">
                            <form action="{{ route('admin.destinasi-wisata.update', $destinasi_wisata->id) }}" method="POST"
                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="destinasi_wisata" id="destinasi_wisata" value="{{ $destinasi_wisata->nama_wisata }}"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="keterangan" id="keterangan" class="note">{{ $destinasi_wisata->keterangan }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 text-center">
                                        <div style="margin-top:30px" id="tampilFoto">
                                            <img src="{{ $destinasi_wisata->thumbnail_destinasi_wisata }}" width="60%"/>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="lat" id="lat" class="form-control" value="{{ $destinasi_wisata->lat }}" onkeyup="showLocation()">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="">Longtitude</label>
                                                <input type="text" name="lng" id="lng" class="form-control" value="{{ $destinasi_wisata->long }}" onkeyup="showLocation()">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
...
@push('js')
    ...
    <script>
        ...
        function loadMedia() {
            // $.get("{{ route('admin.akomodasi.media', $destinasi_wisata->id) }}", (result) => {
            //     console.log(result);
                let json = {!! json_encode($destinasi_wisata->fotovideo) !!}
                let preloaded = [];
                let video_list = [];
        ...
        function fasilitas_selected() {
            ...
            $.ajax({
                type: 'GET',
                url: '{{ route("admin.destinasi-wisata.fasilitas_select2", $destinasi_wisata->id) }}'
            }).then(function (data) {
                console.log(data)
        ...
        $(document).ready(() => {
            ...
            $('select.select2bs4').select2("trigger", "select", {
                data: { id: "{{ $destinasi_wisata->kategori_wisata_id }}", text:'{{ $destinasi_wisata->kategori->nama_kategori_wisata }}' }
            });
