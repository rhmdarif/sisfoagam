...
class DestinasiWisataController extends Controller
{
    ...
    public function getDestinasiWisata()
    {
        try {
            ...
            $data = DestinasiWisata::with(["kategori", "fasilitas", "fotovideo"])->join("kategori_wisata", "kategori_wisata.id", '=', "destinasi_wisata.kategori_wisata_id")->select("destinasi_wisata.*", "kategori_wisata.slug_kategori_wisata")->paginate(9);
    ...
    public function getReview($slugDestinasiWisata = null)
    {
        try {
            ...
            ->select("destinasi_wisata_review_wisata.id", "destinasi_wisata_review_wisata.user_id",  "destinasi_wisata_review_wisata.destinasi_wisata_id", "destinasi_wisata_review_wisata.tingkat_kepuasan", "destinasi_wisata_review_wisata.komentar", "destinasi_wisata_review_wisata.created_at", "users.name")->get();
